...
INSERT INTO conditions (abbreviation, name, description, sort_order) VALUES
  ('M', 'Mint', 'Perfect, as issued. No defects, no wear, no marks. Extremely rare in older books.', 1),
  ('F+', 'Fine Plus', 'Nearly mint with only the slightest signs of age or handling.', 2),
  ...
  ('P', 'Poor', 'Very worn but still readable and complete. May have significant damage but holds together. Reading copy only.', 9)
