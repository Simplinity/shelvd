...
import { Shield, Users, MessageSquare, Activity, BarChart3, ArrowLeft } from 'lucide-react'
...
export function AdminSidebar({ badges }: { badges: { support?: number } }) {
  ...
  return (
    <aside className="w-[200px] bg-red-50/60 border-r border-red-200/60 flex flex-col h-full">
      {/* Admin branding */}
