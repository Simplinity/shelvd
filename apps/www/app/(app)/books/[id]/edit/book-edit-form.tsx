        ...
        <section>
          ...
          {(() => {
            const catalogBook = {
                ...
                edge_treatment: formData.edge_treatment,
                endpapers_type: formData.endpapers_type,
                text_block_condition: formData.text_block_condition,
                ...
                has_dust_jacket: formData.has_dust_jacket,
                is_signed: formData.is_signed,
                signature_details: formData.signature_details,
                ...
                dust_jacket_condition_name: referenceData.conditions.find(c => c.id === formData.dust_jacket_condition_id)?.name || null,
                language_name: referenceData.languages.find(l => l.id === formData.language_id)?.name_en || null,
                original_language_name: referenceData.languages.find(l => l.id === formData.original_language_id)?.name_en || null,
                ...
                lccn: formData.lccn,
                user_catalog_id: formData.user_catalog_id,
                ddc: formData.ddc,
                lcc: formData.lcc,
                udc: formData.udc,
            ...
            return <>
          <div>
            <CatalogEntryGenerator book={catalogBook} mode="trade" onGenerate={entry => { handleChange('catalog_entry', entry); setIsDirty(true) }} />
          ...
          <div className="mt-4">
            <CatalogEntryGenerator book={catalogBook} mode="isbd" onGenerate={entry => { handleChange('catalog_entry_isbd', entry); setIsDirty(true) }} />
