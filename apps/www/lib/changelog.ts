...
export const CHANGELOG: ChangelogRelease[] = [
  {
    ...
    changes: [
      ...
      { type: 'added', text: 'Invite codes — optional promo codes on signup for attribution and benefits. Create codes for bloggers, bookfairs, social campaigns. Each code can grant trial days or lifetime Collector Pro' },
