...
export const EVIDENCE_TYPES: Record<string, Record<CatalogLanguage, string>> = {
  bookplate:      { en: 'Bookplate', fr: 'Ex-libris', de: 'Exlibris', nl: 'Exlibris', es: 'Ex-libris', pt: 'Ex-libris', it: 'Ex-libris', sv: 'Exlibris', da: 'Exlibris', no: 'Exlibris', 'be-fr': 'Ex-libris', 'be-nl': 'Exlibris', la: 'Ex libris' },
  inscription:    { en: 'Ownership inscription', fr: 'Inscription de propriété', de: 'Besitzvermerk', nl: 'Eigendomsinscriptie', es: 'Inscripción de propiedad', pt: 'Inscrição de propriedade', it: 'Nota di possesso', sv: 'Ägaranteckning', da: 'Ejerinskription', no: 'Eierinskripsjone', 'be-fr': 'Inscription de propriété', 'be-nl': 'Eigendomsinscriptie', la: 'Inscr. possess.' },
  stamp:          { en: 'Stamp', fr: 'Cachet', de: 'Stempel', nl: 'Stempel', es: 'Sello', pt: 'Carimbo', it: 'Timbro', sv: 'Stämpel', da: 'Stempel', no: 'Stempel', 'be-fr': 'Cachet', 'be-nl': 'Stempel', la: 'Sigillum' },
  annotation:     { en: 'Marginalia', fr: 'Annotations marginales', de: 'Marginalien', nl: 'Marginalia', es: 'Anotaciones marginales', pt: 'Anotações marginais', it: 'Postille', sv: 'Marginalanteckningar', da: 'Marginalnoter', no: 'Marginalnoter', 'be-fr': 'Annotations marginales', 'be-nl': 'Marginalia', la: 'Notae margin.' },
  binding:        { en: 'Binding mark', fr: 'Marque de reliure', de: 'Einbandzeichen', nl: 'Bandmerk', es: 'Marca de encuadernación', pt: 'Marca de encadernação', it: 'Segno di legatura', sv: 'Bandmärke', da: 'Bindmærke', no: 'Bindmerke', 'be-fr': 'Marque de reliure', 'be-nl': 'Bandmerk', la: 'Nota lig.' },
  shelfmark:      { en: 'Shelfmark', fr: 'Cote', de: 'Signatur', nl: 'Plaatskenmerk', es: 'Signatura topográfica', pt: 'Cota', it: 'Segnatura', sv: 'Hyllsignum', da: 'Hyldesignatur', no: 'Hyllesignatur', 'be-fr': 'Cote', 'be-nl': 'Plaatskenmerk', la: 'Sign. loc.' },
  auction_record: { en: 'Auction record', fr: 'Procès-verbal de vente', de: 'Auktionsnachweis', nl: 'Veilingverslag', es: 'Registro de subasta', pt: 'Registo de leilão', it: 'Verbale d\'asta', sv: 'Auktionsprotokoll', da: 'Auktionsprotokol', no: 'Auksjonsprotokoll', 'be-fr': 'Procès-verbal de vente', 'be-nl': 'Veilingverslag', la: 'Acta auct.' },
  dealer_record:  { en: 'Dealer record', fr: 'Catalogue de libraire', de: 'Händlernachweis', nl: 'Handelaarsverslag', es: 'Registro de librero', pt: 'Registo de livreiro', it: 'Catalogo antiquario', sv: 'Antikvariatsprotokoll', da: 'Antikvariatprotokol', no: 'Antikvariatsprotokoll', 'be-fr': 'Catalogue de libraire', 'be-nl': 'Handelaarsverslag', la: 'Cat. bibl.' },
}

// ─── Association Types ──────────────────────────────────────────────

export const ASSOCIATION_TYPES: Record<string, Record<CatalogLanguage, string>> = {
  dedication_copy:     { en: 'Dedication copy', fr: 'Exemplaire de dédicace', de: 'Widmungsexemplar', nl: 'Opdrachtexemplaar', es: 'Ejemplar de dedicatoria', pt: 'Exemplar de dedicatória', it: 'Copia con dedica', sv: 'Dedikationsexemplar', da: 'Dedikationseksemplar', no: 'Dedikasjonseksemplar', 'be-fr': 'Exemplaire de dédicace', 'be-nl': 'Opdrachtexemplaar', la: 'Exempl. cum dedic.' },
  association_copy:    { en: 'Association copy', fr: 'Exemplaire d\'association', de: 'Assoziationsexemplar', nl: 'Associatie-exemplaar', es: 'Ejemplar de asociación', pt: 'Exemplar de associação', it: 'Copia di associazione', sv: 'Associationsexemplar', da: 'Associationseksemplar', no: 'Assosiasjonseksemplar', 'be-fr': 'Exemplaire d\'association', 'be-nl': 'Associatie-exemplaar', la: 'Exempl. assoc.' },
  presentation_copy:   { en: 'Presentation copy', fr: 'Exemplaire de présentation', de: 'Überreichungsexemplar', nl: 'Presentie-exemplaar', es: 'Ejemplar de presentación', pt: 'Exemplar de apresentação', it: 'Copia di omaggio', sv: 'Presentexemplar', da: 'Præsentationseksemplar', no: 'Presentasjonseksemplar', 'be-fr': 'Exemplaire de présentation', 'be-nl': 'Presentie-exemplaar', la: 'Exempl. praes.' },
  inscribed:           { en: 'Inscribed by author', fr: 'Envoi autographe', de: 'Mit Widmung des Autors', nl: 'Met opdracht van de auteur', es: 'Con dedicatoria del autor', pt: 'Com dedicatória do autor', it: 'Con dedica autografa', sv: 'Med författarens dedikation', da: 'Med forfatterens dedikation', no: 'Med forfatterens dedikasjon', 'be-fr': 'Envoi autographe', 'be-nl': 'Met opdracht van de auteur', la: 'Cum inscr. auct.' },
  signed:              { en: 'Signed by author', fr: 'Signé par l\'auteur', de: 'Vom Autor signiert', nl: 'Gesigneerd door de auteur', es: 'Firmado por el autor', pt: 'Assinado pelo autor', it: 'Firmato dall\'autore', sv: 'Signerad av författaren', da: 'Signeret af forfatteren', no: 'Signert av forfatteren', 'be-fr': 'Signé par l\'auteur', 'be-nl': 'Gesigneerd door de auteur', la: 'Manu auct. subscr.' },
  authors_copy:        { en: "Author's own copy", fr: "Exemplaire de l'auteur", de: 'Handexemplar des Autors', nl: 'Eigen exemplaar van de auteur', es: 'Ejemplar del autor', pt: 'Exemplar do autor', it: "Copia dell'autore", sv: 'Författarens eget exemplar', da: 'Forfatterens eget eksemplar', no: 'Forfatterens eget eksemplar', 'be-fr': "Exemplaire de l'auteur", 'be-nl': 'Eigen exemplaar van de auteur', la: 'Exempl. auct.' },
  annotated:           { en: 'Annotated by notable person', fr: 'Annoté par une personnalité', de: 'Mit Anmerkungen einer Persönlichkeit', nl: 'Geannoteerd door een notabel persoon', es: 'Anotado por persona notable', pt: 'Anotado por pessoa notável', it: 'Annotato da persona illustre', sv: 'Annoterat av bemärkt person', da: 'Annoteret af bemærkelsesværdig person', no: 'Annotert av bemerkelsesverdig person', 'be-fr': 'Annoté par une personnalité', 'be-nl': 'Geannoteerd door een notabel persoon', la: 'Cum notis' },
  from_notable_collection: { en: 'From notable collection', fr: 'Provenant d\'une collection célèbre', de: 'Aus bedeutender Sammlung', nl: 'Uit een beroemde collectie', es: 'De colección notable', pt: 'De colecção notável', it: 'Da collezione celebre', sv: 'Från berömd samling', da: 'Fra berømt samling', no: 'Fra berømt samling', 'be-fr': 'Provenant d\'une collection célèbre', 'be-nl': 'Uit een beroemde collectie', la: 'Ex collect. celeb.' },
  ex_library:          { en: 'Ex-library', fr: 'Ex-bibliothèque', de: 'Aus Bibliotheksbestand', nl: 'Ex-bibliotheek', es: 'Ex-biblioteca', pt: 'Ex-biblioteca', it: 'Ex-biblioteca', sv: 'Biblioteksexemplar', da: 'Bibliotekseksemplar', no: 'Bibliotekseksemplar', 'be-fr': 'Ex-bibliothèque', 'be-nl': 'Ex-bibliotheek', la: 'Ex bibl.' },
  review_copy:         { en: 'Review copy', fr: 'Service de presse', de: 'Rezensionsexemplar', nl: 'Recensie-exemplaar', es: 'Ejemplar de prensa', pt: 'Exemplar de imprensa', it: 'Copia stampa', sv: 'Recensionsexemplar', da: 'Anmeldereksemplar', no: 'Anmeldereksemplar', 'be-fr': 'Service de presse', 'be-nl': 'Recensie-exemplaar', la: 'Exempl. recens.' },
  subscriber_copy:     { en: 'Subscriber copy', fr: 'Exemplaire de souscription', de: 'Subskriptionsexemplar', nl: 'Intekenaarsexemplaar', es: 'Ejemplar de suscripción', pt: 'Exemplar de subscrição', it: 'Copia per sottoscrittore', sv: 'Prenumerationsexemplar', da: 'Abonnementseksemplar', no: 'Abonnementseksemplar', 'be-fr': 'Exemplaire de souscription', 'be-nl': 'Intekenaarsexemplaar', la: 'Exempl. subscr.' },
  prize_copy:          { en: 'Prize copy', fr: 'Exemplaire de prix', de: 'Preisexemplar', nl: 'Prijsexemplaar', es: 'Ejemplar de premio', pt: 'Exemplar de prémio', it: 'Copia premio', sv: 'Prisexemplar', da: 'Præmieeksemplar', no: 'Premieeksemplar', 'be-fr': 'Exemplaire de prix', 'be-nl': 'Prijsexemplaar', la: 'Exempl. praemii' },
  working_copy:        { en: 'Working copy', fr: 'Exemplaire de travail', de: 'Arbeitsexemplar', nl: 'Werkexemplaar', es: 'Ejemplar de trabajo', pt: 'Exemplar de trabalho', it: 'Copia di lavoro', sv: 'Arbetsexemplar', da: 'Arbejdseksemplar', no: 'Arbeidseksemplar', 'be-fr': 'Exemplaire de travail', 'be-nl': 'Werkexemplaar', la: 'Exempl. laboris' },
}

// ─── Protective Enclosure Types ─────────────────────────────────────

export const ENCLOSURE_TYPES: Record<string, Record<CatalogLanguage, string>> = {
  slipcase_publisher: { en: "Publisher's slipcase", fr: 'Étui éditeur', de: 'Verlagsschuber', nl: 'Uitgeversfoedraal', es: 'Estuche editorial', pt: 'Estojo editorial', it: 'Custodia editoriale', sv: 'Förlagskassett', da: 'Forlagskassette', no: 'Forlagskassett', 'be-fr': 'Étui éditeur', 'be-nl': 'Uitgeversfoedraal', la: 'Theca edit.' },
  slipcase_custom:    { en: 'Custom slipcase', fr: 'Étui sur mesure', de: 'Schuber (Maßanfertigung)', nl: 'Foedraal op maat', es: 'Estuche a medida', pt: 'Estojo por medida', it: 'Custodia su misura', sv: 'Specialkassett', da: 'Specialkassette', no: 'Spesialkassett', 'be-fr': 'Étui sur mesure', 'be-nl': 'Foedraal op maat', la: 'Theca' },
  clamshell_box:      { en: 'Clamshell box', fr: 'Boîte à rabat', de: 'Kassette', nl: 'Clamshell doos', es: 'Caja clamshell', pt: 'Caixa clamshell', it: 'Scatola a conchiglia', sv: 'Musselbox', da: 'Muslingeboks', no: 'Muslingboks', 'be-fr': 'Boîte à rabat', 'be-nl': 'Clamshell doos', la: 'Capsa' },
  chemise:            { en: 'Chemise', fr: 'Chemise', de: 'Chemise', nl: 'Chemise', es: 'Camisa', pt: 'Camisa', it: 'Camicia', sv: 'Chemise', da: 'Chemise', no: 'Chemise', 'be-fr': 'Chemise', 'be-nl': 'Chemise', la: 'Involucrum' },
  solander_box:       { en: 'Solander box', fr: 'Boîte Solander', de: 'Solander-Kassette', nl: 'Solander doos', es: 'Caja Solander', pt: 'Caixa Solander', it: 'Scatola Solander', sv: 'Solanderbox', da: 'Solanderboks', no: 'Solanderboks', 'be-fr': 'Boîte Solander', 'be-nl': 'Solander doos', la: 'Capsa Solander' },
}
