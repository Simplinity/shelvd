...
export const WIKI_ARTICLES: WikiArticle[] = [
  ...
  { number: 10, slug: 'bindings-and-covers', filename: 'bindings-and-covers.md', title: '45 Ways to Dress a Book', subtitle: 'Every cover type in Shelvd, from full calf to paper wrappers — what they are, how to identify them, and why they matter.', category: 'cataloging', relatedBlog: ['vellum-calf-morocco'], relatedWiki: ['binding-styles'] },
  ...
  { number: 14, slug: 'the-isbd-entry', filename: 'the-isbd-entry.md', title: 'ISBD: The Catalog Entry Nobody Writes by Hand Anymore', subtitle: 'The complete guide to ISBD catalog entries — every area, every punctuation rule, worked examples, and how Shelvd generates them in four languages.', category: 'cataloging', relatedBlog: ['what-is-isbd'], relatedWiki: ['the-title-page'] },
  ...
  { number: 16, slug: 'provenance-tracking', filename: 'provenance-tracking.md', title: 'Who Had This Book Before You (And Why That Matters)', subtitle: 'The provenance chain in Shelvd: owner types, evidence types, associations, and the detective work of book history.', category: 'provenance', relatedBlog: ['provenance-who-had-this-book', 'ex-libris-history'] },
  { number: 17, slug: 'condition-history', filename: 'condition-history.md', title: 'A Medical Record for Books', subtitle: 'Tracking condition over time — logging changes, dating observations, and building a health record your book deserves.', category: 'provenance', relatedWiki: ['condition-grading'] },
  { number: 18, slug: 'valuation-history', filename: 'valuation-history.md', title: 'What\'s It Worth? A History of Guessing', subtitle: 'Seven valuation sources, trend tracking over time, provenance auto-sync, and the art of estimating value without a crystal ball.', category: 'provenance', relatedBlog: ['first-edition-glossary'] },
  { number: 19, slug: 'external-links', filename: 'external-links.md', title: '64 Doors to the Outside World', subtitle: 'External link types across eight categories — from WorldCat to Christie\'s — and how to connect your books to the wider bibliographic universe.', category: 'provenance', relatedWiki: ['configuring-links'] },

  // ── IV. SEARCH & DISCOVERY ──────────────────────────────────────────
  { number: 20, slug: 'searching-your-library', filename: 'searching-your-library.md', title: 'Finding That One Book You Know You Own', subtitle: 'Global search, advanced search with 14 fields and AND/OR logic, filters, sorting, and the eternal quest for that one Elzevir.', category: 'search', relatedWiki: ['collections-and-tags'] },
  { number: 21, slug: 'duplicate-detection', filename: 'duplicate-detection.md', title: 'The Awkward Conversation: You Own This Twice', subtitle: 'How duplicate detection works, what it matches on, bulk cleanup, and the uncomfortable truth about your purchasing habits.', category: 'search' },
  { number: 22, slug: 'the-22-providers', filename: 'the-22-providers.md', title: 'A Grand Tour of 22 Libraries in 19 Countries', subtitle: 'Every lookup provider in Shelvd — what it holds, what it\'s good at, its quirks, and when to reach for it.', category: 'search', relatedWiki: ['library-lookup', 'configuring-providers'] },

  // ── V. DATA & EXPORT ────────────────────────────────────────────────
  { number: 23, slug: 'import-export', filename: 'import-export.md', title: 'Getting Data In and Out Without Losing Your Mind', subtitle: 'Excel import with template, CSV/JSON/Excel export, what goes in each format, and what doesn\'t.', category: 'data', relatedWiki: ['importing-your-spreadsheet'] },
  { number: 24, slug: 'statistics', filename: 'statistics.md', title: 'Numbers About Your Books (the Other Kind of Value)', subtitle: 'The statistics dashboard: key metrics, distributions, top lists, and what the numbers reveal about your collecting habits.', category: 'data' },
  { number: 25, slug: 'collection-audit', filename: 'collection-audit.md', title: 'The Audit: A Gentle Reckoning', subtitle: 'Ten health checks, a score out of 100, expandable fix lists, and the motivational guilt trip your catalog needs.', category: 'data', relatedWiki: ['your-first-book'] },

  // ── VI. SETTINGS & ACCOUNT ──────────────────────────────────────────
  { number: 26, slug: 'settings-guide', filename: 'settings-guide.md', title: 'Everything in Settings, Explained', subtitle: 'Profile, security, locale, currency, display preferences — every toggle and dropdown, demystified.', category: 'settings' },
  { number: 27, slug: 'configuring-providers', filename: 'configuring-providers.md', title: 'Choosing Your Libraries', subtitle: 'Enable, disable, and reorder your lookup providers — because not every library is relevant to every collection.', category: 'settings', relatedWiki: ['the-22-providers', 'library-lookup'] },
  { number: 28, slug: 'configuring-links', filename: 'configuring-links.md', title: 'Choosing Your External Links', subtitle: 'Activate, deactivate, and create custom link types — 64 system types across eight categories, plus your own.', category: 'settings', relatedWiki: ['external-links'] },

  // ── VII. GLOSSARY & REFERENCE ────────────────────────────────────────
  { number: 29, slug: 'glossary', filename: 'glossary.md', title: 'A Glossary for People Who Collect Books and Arguments', subtitle: '150+ terms from the world of rare books, antiquarian trade, and bibliographic description — defined with unreasonable precision and occasional humor.', category: 'reference' },
  { number: 30, slug: 'condition-terms', filename: 'condition-terms.md', title: 'A Visual Guide to Foxing, Toning, and Everything Brown', subtitle: 'The vocabulary of paper degradation and book damage — what each term means, what causes it, and how to describe it without crying.', category: 'reference', relatedBlog: ['foxing-browning-toning'], relatedWiki: ['condition-grading'] },
  { number: 31, slug: 'binding-styles', filename: 'binding-styles.md', title: 'From Chain Stitch to Perfect Binding: A Timeline', subtitle: 'Historical binding techniques from the medieval scriptorium to the modern paperback — identification tips included.', category: 'reference', relatedBlog: ['vellum-calf-morocco'], relatedWiki: ['bindings-and-covers'] },
  { number: 32, slug: 'book-formats-reference', filename: 'book-formats-reference.md', title: 'The 76 Formats (And Why "Large Octavo" Is Not "Small Quarto")', subtitle: 'Every bibliographic format in Shelvd with dimensions, abbreviations, and historical context — from broadsheet to 128mo.', category: 'reference', relatedBlog: ['book-formats'], relatedWiki: ['physical-description'] },
  { number: 33, slug: 'marc-roles', filename: 'marc-roles.md', title: 'The 69 MARC Relator Codes, Decoded', subtitle: 'Every contributor role in Shelvd — from "author" to "woodcutter" — with definitions and guidance on when to use each one.', category: 'reference', relatedWiki: ['contributors'] },

  // ── VIII. FOR DEALERS ────────────────────────────────────────────────
  { number: 34, slug: 'cataloging-for-dealers', filename: 'cataloging-for-dealers.md', title: 'Cataloging to Sell: What Buyers Actually Look For', subtitle: 'Professional cataloging standards for the trade — which fields matter, what condition notes to write, and how to describe a book so someone buys it.', category: 'dealers', relatedBlog: ['bookseller-condition-scale', 'book-fair-survival'], relatedWiki: ['condition-grading', 'the-isbd-entry'] },
  { number: 35, slug: 'pdf-catalog-sheets', filename: 'pdf-catalog-sheets.md', title: 'The Catalog Sheet: One Page Per Book', subtitle: 'PDF generation in six paper sizes — what\'s included, how to customize it, and when to hand one to a prospective buyer.', category: 'dealers' },
]
