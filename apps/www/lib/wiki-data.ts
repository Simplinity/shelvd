...
export const WIKI_ARTICLES: WikiArticle[] = [
  ...
  { number: 2, slug: 'library-lookup', filename: 'library-lookup.md', title: 'Library Lookup: Let the World\'s Libraries Do Your Typing', subtitle: 'How to search 27 providers across 20 countries, pick a source, and import metadata without lifting a pen.', category: 'getting-started', relatedWiki: ['the-22-providers', 'enriching-a-record', 'configuring-providers'], relatedBlog: ['isbn-invented-1970'] },
  ...
  { number: 23, slug: 'the-22-providers', filename: 'the-22-providers.md', title: 'A Grand Tour of 27 Libraries in 20 Countries', subtitle: 'Every lookup provider in Shelvd — what it holds, what it\'s good at, its quirks, and when to reach for it.', category: 'search', relatedWiki: ['library-lookup', 'configuring-providers'] },
